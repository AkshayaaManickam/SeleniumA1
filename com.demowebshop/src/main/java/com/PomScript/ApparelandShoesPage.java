...
public class ApparelandShoesPage extends BasePage
{
     ...
     * Leather bag details
     */
    @FindBy(xpath="//a[contains(text(),'Genuine Leather Handbag')]")
    public WebElement bagproduct; //product link
    
    @FindBy(xpath="(//div[@class='rating'])[7]")
    public WebElement bagrating; //rating
    
    @FindBy(xpath="(//span[@class='price actual-price'])[7]")
    public WebElement bagprice; //price
    
    @FindBy(xpath="(//input[@value='Add to cart'])[5]")
    public WebElement bagcart;
